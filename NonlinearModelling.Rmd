...
We can attempt to construct a range of different degree polynomial regression models and use the validation set approach to choose the best one.
...
As can be seen, the model that has the best test MSE is a third degree polynomial model.
