...
lines(fit2)
>>>>>>> c819ada44f896437ee4ee1c8c770316c8385cd92
```
...
```
The model with two variables has the lowest test error, so we used this model for the rest of our analysis, to vary the degrees of freedom of the predictor variables.
